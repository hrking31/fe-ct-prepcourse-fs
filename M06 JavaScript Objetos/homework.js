...
function nuevoUsuario(nombre, email, password) {
  ...
  nuevapersona.password = password;
  return nuevapersona;
}
...
function tienePropiedad(objeto, propiedad) {
  ...
  // Tu código:
  var prop = 0;
  if ((prop = objeto.hasOwnProperty([propiedad]))) return prop;
  else return false;
}
...
function sumarLikesDeUsuario(objetoUsuario) {
  ...
  // Tu código:
  var suma = 0;
  for (var usuarios in objetoUsuario.posts) {
    suma += suma = objetoUsuario.posts[usuarios].likes;
  }
  return suma;
}
